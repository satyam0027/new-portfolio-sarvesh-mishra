      ...
      <div className="container mx-auto grid grid-cols-1 md:grid-cols-3 gap-12 px-4">
        <div>
          ...
          <ul className="space-y-4">
            <li>
              <a 
                href="https://redhotmediahouse.com/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-700 hover:text-yellow-600 transition-colors duration-300 font-medium tracking-wide"
              >
                Red Hot Media House
              </a>
            </li>
        ...
        <div>
          ...
          <ul className="space-y-4">
            ...
            <li>
              <a 
                href="https://www.youtube.com/@FeverTravel" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-gray-700 hover:text-yellow-600 transition-colors duration-300 font-medium tracking-wide"
              >
        ...
        <div>
          ...
          <div className="flex space-x-6">
            ...
            <a 
              href="https://www.facebook.com/sarveshmishrashow/" 
              target="_blank" 
              rel="noopener noreferrer" 
              aria-label="Facebook"
